...
% bullsEyeDistanceAll.m - "Returns distance from bullseye with angle, velocity, mass and
% intitial y as parameters"
% modified version of "bullsEyeDistanceA.m"

% x0 & y0: initial coordinates; v0: initial velocity; 
% h: step-length; a: angle; m: mass

function [distance, x, y] = bullsEyeDistanceAll(y0, v0, h, a, m)
    x0 = 0;
    xend = 2.37;
    yp = v0*sind(a);
    xp = v0*cosd(a);
